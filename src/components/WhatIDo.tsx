        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building responsive and scalable web and mobile applications using modern frameworks.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">JavaScript & Java</div>
                ...
                <div className="what-tags">Flutter Basics</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Hands-on experience with Artificial Intelligence, Computer Vision, and Data Analysis.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
